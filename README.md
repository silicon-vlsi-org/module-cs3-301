...
2. If you are using a Windows desktop/laptop, download and install [VirtualBox](https://virtualbox.org) and install a Linux distro on it eg. [Ubuntu](https://brb.nci.nih.gov/seqtools/installUbuntu.html). Use the linux Virtual Machine (VM) to go through the lessons.
